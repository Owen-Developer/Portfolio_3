...
setTimeout(() => {
    ...
    projectBoxes[0].style.maxHeight = initHeight;
    projectBoxes[0].style.borderBottom = "1px solid transparent";
    arrowContainers[0].style.backgroundColor = "hsl(253, 100%, 64%)";
    arrowContainers[0].style.border = "2px solid hsl(253, 100%, 64%)";
    arrowContainers[0].style.transform = "rotate(90deg)";
}, 100);
